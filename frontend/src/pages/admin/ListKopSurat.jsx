...
const ListKopSurat = () => {
  ...
  const handleDelete = async (kopSuratId, kopSuratName) => {
    if (!window.confirm(`Apakah Anda yakin ingin menghapus kop surat "${kopSuratName}"?`)) {
      return;
    }
  ...
  const handleActivate = async (kopSuratId, kopSuratName) => {
    if (!window.confirm(`Apakah Anda yakin ingin mengaktifkan kop surat "${kopSuratName}"?`)) {
      return;
    }
  ...
  const handleDeactivate = async (kopSuratId, kopSuratName) => {
    if (!window.confirm(`Apakah Anda yakin ingin menonaktifkan kop surat "${kopSuratName}"?`)) {
      return;
    }
