  ...
  if (submitted) {
    return (
      <div className="max-w-xl mx-auto bg-white p-10 rounded-xl shadow-2xl text-center my-12 border-t-8 border-green-600">
        ...
        {submitResult?.certificate_sent ? (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
            <div className="flex items-center justify-center gap-2 text-green-700">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
              </svg>
              <span className="font-semibold">Sertifikat Terkirim!</span>
            </div>
            <p className="text-sm text-green-600 mt-2">
              Sertifikat telah dikirim ke <strong>{submitResult.email_sent_to}</strong>
            </p>
            <p className="text-xs text-green-500 mt-1">Silakan periksa folder inbox atau spam email Anda.</p>
          </div>
        ) : (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <div className="flex items-center justify-center gap-2 text-yellow-700">
              ...
              <span className="font-semibold">Sertifikat Sedang Diproses</span>
            </div>
            <p className="text-sm text-yellow-600 mt-2">
              Sertifikat akan segera dikirimkan ke email terdaftar.
            </p>
          </div>
        )}
        <button
