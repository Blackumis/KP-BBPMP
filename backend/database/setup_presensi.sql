-- ============================================
-- Setup Database for KP-BBPMP Presensi
-- Matches .env: DB_NAME=Presensi
-- ============================================
...
INSERT IGNORE INTO kabupaten_kota (nama, tipe) VALUES
...
CREATE TABLE IF NOT EXISTS kop_surat (
  id INT AUTO_INCREMENT PRIMARY KEY,
  nama_data VARCHAR(255) NOT NULL COMMENT 'Nama instansi/unit',
  ...
  jenis_ttd ENUM('QR', 'BASAH') DEFAULT 'QR' COMMENT 'Jenis tanda tangan',
